...
with python 3.6, for example
# conda activate <env_name>               #  -> # go into the virtual 
environment
...
python3 -m ipykernel install --user --name $myenv --display-name 
"$full_name"
# old ecdsa install
pip install ecdsa
# py-ethereum and tester
sudo apt-get install libssl-dev build-essential automake pkg-config 
libtool libffi-dev libgmp-dev libyaml-cpp-dev
